...
set NETLIST_OUT         ${NETLIST_DIR}/power/${DESIGN_NAME}_timing_netlist.v
...
redirect -tee ${LOG_FILE} {
    ...
    report_timing -max_paths 10 \
                  -delay_type max \
                  -sort_by slack \
                  > ${RPT_DIR}/${DESIGN_NAME}_timing_timing_setup.log

    report_timing -max_paths 10 \
                  -delay_type min \
                  -sort_by slack \
                  > ${RPT_DIR}/${DESIGN_NAME}_timing__timing_hold.log

    report_qor    > ${RPT_DIR}/${DESIGN_NAME}_timing__qor.log

    report_area   -hierarchy \
                  > ${RPT_DIR}/${DESIGN_NAME}_timing__area.log

    report_power  -hierarchy \
                  > ${RPT_DIR}/${DESIGN_NAME}_timing__power.log

    report_constraint -all_violators \
                  > ${RPT_DIR}/${DESIGN_NAME}_timing__violations.log

    report_clock_gating \
                  > ${RPT_DIR}/${DESIGN_NAME}_timing__clock_gating.log
